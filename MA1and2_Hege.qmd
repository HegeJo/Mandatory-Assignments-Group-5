...
```{r}
huxreg(
 list("Total" = lm_allcountries, "Turkey" = lm_Turkey, "UK" = lm_UK),
...
geom_point(aes(x = log_GDP_pc, y = gini_n2)) +
  geom_abline(intercept = b1_Turkey, slope = b2_Turkey, colour = "orange", size = 1) +
...
plot_turkey2010 <- Turkey2010_nuts2 %>% 
...
pred_regdev_regineq <- data2010_nuts2 %>% 
  add_predictions(model = lm_allcountries)
