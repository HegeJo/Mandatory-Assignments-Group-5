...
**Andre: How can i fix the layout for the plot? it does not look very good:**
...
**Andre: Is this correct - same gini for all years for each region?**
...
```{r ranking order gini Czech Rep}
#| echo: false
...
**Andre: How can I get the following results in opposite order?:**
