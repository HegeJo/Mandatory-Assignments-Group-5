...
For this category I have selected the variable Total railway lines, which is measured in kilometers.
The data is imported from the dataset TGS00113[^10], which is computed from the dataset TRAN_R\_NET[^11]
.

[^10]: <https://ec.europa.eu/eurostat/databrowser/view/tgs00113/default/table?lang=en>

[^11]: <https://ec.europa.eu/eurostat/databrowser/view/TRAN_R_NET/default/table?lang=en>
